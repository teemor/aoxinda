...
Page({
  ...
  saveSort: function() {
    this.selectGoodsList({
      goods_brand: this.data.goods_brand,
      start_price: this.data.startPrice,
      end_price: this.data.endPrice,
      goodsType: this.data.goodsType,
      sailNum: 'sailNum',
      sorting: this.data.desc ? 'desc' : 'asc',
  ...
  addSort: function(e) {
    if (e.currentTarget.dataset.item.name === "销量") {
      ...
      this.selectGoodsList({
        ...
        sorting: this.data.desc ? 'asc' : 'desc',
        goodsName: this.data.goodsName
      })
  ...
  onLoad: function(options) {
    ...
    let id = JSON.parse(model).id ? JSON.parse(model).id : JSON.parse(model).detail_id
